...
class MessengerService : Service() {
    ...
    suspend fun createRoom(name: String, isPublic: Boolean, description: String = "") = client.createRoom(name, isPublic, description)
    suspend fun joinRoom(roomId: Long) = client.joinRoom(roomId)
    suspend fun leaveRoom(roomId: Long) = client.leaveRoom(roomId)
    suspend fun inviteToRoom(roomId: Long, username: String) = client.inviteToRoom(roomId, username)
    suspend fun sendRoomMessage(roomId: Long, text: String) = client.sendRoomMessage(roomId, text)
