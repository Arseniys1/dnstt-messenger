...
1. Установи APK (спроси у администратора или собери из папки `android-client`)
2. В настройках приложения укажи адрес прокси: `127.0.0.1:18000`
3. Запусти MasterDnsVPN для Android на телефоне (APK — с той же страницы releases, ищи `Android`)
